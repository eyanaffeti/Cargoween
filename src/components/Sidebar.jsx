        ...
        <nav className="mt-4 flex flex-col space-y-2 px-4">
          ...
          {isOpen && userMenuOpen && (
            <div className="ml-8 flex flex-col space-y-2 text-sm">
              <SidebarSubLink icon={<FaPlus />} text="Ajouter un utilisateur" href="/Transitaire/Comptes/Ajout" />
              <SidebarSubLink icon={<FaUsers />} text="Liste des transitaires" href="/Transitaire/Comptes/Liste" />
